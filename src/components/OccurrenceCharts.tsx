...
const chartDescriptions = {
  topCities: "Este gráfico mostra as 10 cidades com maior número de ocorrências, coloridas por nível de severidade predominante. Barras mais longas indicam mais ocorrências.",
  crimeEvolution: "Evolução anual das ocorrências por tipo de crime. Selecione o tipo de crime para visualizar a tendência ao longo dos anos.",
  yearlyTotal: "Comparativo anual do total de ocorrências registradas. Barras em tons mais claros representam anos em andamento com dados parciais.",
  distribution: "Distribuição percentual das ocorrências por nível de prioridade. Cada segmento representa uma proporção das ocorrências totais conforme sua classificação de gravidade."
};
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-6">
              ...
              <TooltipProvider>
                <UITooltip>
                  ...
                  <TooltipContent className="p-3 max-w-xs">
                    <p>{chartDescriptions.topCities}</p>
                  </TooltipContent>
                </UITooltip>
              </TooltipProvider>
            </div>

            <Select value={topCitiesYear} onValueChange={setTopCitiesYear}>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={isMobile ? 300 : 400}>
              ...
              >
                ...
                <Bar dataKey="count" nameKey="city" fill="#8884d8">
      ...
      >
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div className="flex items-center gap-2">
              <CardTitle className="text-base sm:text-lg md:text-xl">Evolução das Ocorrências</CardTitle>
              <TooltipProvider>
                <UITooltip>
                  <TooltipTrigger asChild>
                    <HelpCircle className="h-4 w-4 text-muted-foreground cursor-help" />
                  ...
                  <TooltipContent className="p-3 max-w-xs">
                    <p>{chartDescriptions.crimeEvolution}</p>
                  </TooltipContent>
                </UITooltip>
              </TooltipProvider>
            </div>
            ...
            <ResponsiveContainer width="100%" height={220}>
              ...
              >
                ...
                <Line
                  type="monotone"
                  dataKey="count"
                  name={crimeType.charAt(0).toUpperCase() + crimeType.slice(1)}
      ...
      >
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div className="flex items-center gap-2">
              <CardTitle className="text-base sm:text-lg md:text-xl">Total Anual</CardTitle>
              <TooltipProvider>
                <UITooltip>
                  <TooltipTrigger asChild>
                    <HelpCircle className="h-4 w-4 text-muted-foreground cursor-help" />
                  ...
                  <TooltipContent className="p-3 max-w-xs">
                    <p>{chartDescriptions.yearlyTotal}</p>
                  </TooltipContent>
                </UITooltip>
              </TooltipProvider>
            </div>
                ...
                >
                  {yearlyData.map((entry, index) => (
                    <Cell 
                      ...
                      opacity={entry.emProgresso ? 0.7 : 1}
                    />
                  ))}
                </Bar>
              </BarChart>
      ...
      >
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div className="flex items-center gap-2">
              <CardTitle className="text-base sm:text-lg md:text-xl">Distribuição por Prioridade</CardTitle>
              <TooltipProvider>
                <UITooltip>
                  <TooltipTrigger asChild>
                    <HelpCircle className="h-4 w-4 text-muted-foreground cursor-help" />
                  ...
                  <TooltipContent className="p-3 max-w-xs">
                    <p>{chartDescriptions.distribution}</p>
                  </TooltipContent>
                </UITooltip>
              </TooltipProvider>
            </div>
